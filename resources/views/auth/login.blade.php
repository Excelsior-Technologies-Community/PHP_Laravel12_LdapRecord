...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white shadow-lg rounded-xl w-full max-w-md p-8">
        ...
        <form method="POST" action="{{ route('ldap.login') }}" class="space-y-4">
            ...
            <div>
                <label class="block text-gray-700 mb-1" for="domain">Select Domain</label>
                <select name="domain" id="domain" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none">
                    <option value="default">Primary Domain</option>
