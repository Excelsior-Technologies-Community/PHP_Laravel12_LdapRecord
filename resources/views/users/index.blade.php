    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white shadow-md rounded-xl p-6 mb-6 flex justify-between items-center">
            ...
            <div class="flex gap-3">
                <a href="{{ url('audit-logs') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg text-sm transition">
                    📜 Audit Logs
                </a>
                ...
                <tbody class="divide-y">
                    @forelse($users as $user)
                        <tr class="hover:bg-gray-50 transition">
                            <td class="p-4 font-medium text-gray-600">#{{ $user->id }}</td>
                            <td class="p-4">
